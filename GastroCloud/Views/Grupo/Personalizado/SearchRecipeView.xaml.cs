...
namespace GastroCloud.Views.Grupo.Personalizado
{
    ...
    public sealed partial class SearchRecipeView : Page
    {
        public SearchRecipeView()
        {
            ...
            gridIElaborados.ItemsSource = almacen.getDescuento();
            txtBuscador.Focus(FocusState.Programmatic);
        }

        private void selection_PointerPressed(object sender, PointerRoutedEventArgs e)
        {
            this.Frame.Navigate(typeof(Views.Grupo.Personalizado.ItemDetailRecipeView));
        }

        private void cancel(object sender, PointerRoutedEventArgs e)
        {
            this.Frame.Navigate(typeof(Views.Grupo.Personalizado.FormPortion), 1);
        }
        ...
        {
            this.Frame.Navigate(typeof(Views.Grupo.Personalizado.SearchRecipeView));
        }
    }
}
